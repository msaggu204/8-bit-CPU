...
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { enter }]; #IO_L24P_T3_34 Sch=sw[1]
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { change_output }]; #IO_L4N_T0_34 Sch=sw[2]
...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { change_output }]; #IO_L7P_T1_34 Sch=btn[3]
